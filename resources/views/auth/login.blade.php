                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" onclick="validations();">Sign in</button>
    ...
    <script type="text/javascript">
        function validations()
        {
            ...
            var uemail=document.getElementById('email').value;
                ...
                if((username==uemail) && (pass==pass)){

                    swal("good job","your detail has been matched","success");
                }
                else{
